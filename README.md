...
1. VS Code mein `README.md` me yeh text daal kar `Ctrl + S` daba kar **Save** karein.
2. Apne terminal mein Git commands chalate waqt yeh file automatically include ho jayegi:
   ```bash
   git add .
